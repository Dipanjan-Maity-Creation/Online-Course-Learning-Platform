...
function Blog() {
  const posts = [
    {
      title: '5 Tips for Beginner Traders',
      date: 'June 28, 2025',
      excerpt: 'Start your trading journey with these essential tips to build a strong foundation.',
    },
    {
      title: 'The Rise of Cryptocurrency in 2025',
      date: 'July 01, 2025',
      excerpt: 'Explore the latest trends and opportunities in the crypto market this year.',
    },
    {
      title: 'How to Read Candlestick Charts',
      date: 'July 02, 2025',
      excerpt: 'Master the art of reading candlestick charts to improve your trading accuracy.',
    },
  ];
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 exo-regular">Blog</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Stay updated with the latest trading insights, tips, and market analysis.
            </p>
          </div>
          <div className="max-w-4xl mx-auto space-y-6">
            {posts.map((post, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold mb-2 exo-regular">{post.title}</h3>
