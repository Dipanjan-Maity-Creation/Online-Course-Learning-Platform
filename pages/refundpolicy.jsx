      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 exo-regular">Refund Policy</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Review our refund policy to understand your options for course purchases at TradingGuru.
            </p>
          </div>
          <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 exo-regular">Refund Eligibility</h3>
            <p className="text-gray-600 mb-4">
              TradingGuru offers a 30-day money-back guarantee for all course purchases. To be eligible
              for a refund, you must request it within 30 days of your purchase date. Refunds are
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4 space-y-2">
              ...
              <li>The request is submitted via our Support Center with a valid reason.</li>
            </ul>

            <h3 className="text-xl font-semibold mb-4 exo-regular">Refund Process</h3>
            <p className="text-gray-600 mb-4">
              To initiate a refund, please follow these steps:
            </p>
            <ol className="list-decimal list-inside text-gray-600 mb-4 space-y-2">
              <li>Log in to your TradingGuru account.</li>
              <li>Navigate to the Support Center and select "Submit a Ticket."</li>
              <li>Provide your order number and a detailed reason for the refund request.</li>
              <li>Our team will review your request within 5-7 business days and notify you via email.</li>
            </ol>

            <h3 className="text-xl font-semibold mb-4 exo-regular">Non-Refundable Items</h3>
            <p className="text-gray-600 mb-4">
              The following are not eligible for a refund:
            </p>
            <ul className="list-disc list-inside text-gray-600 mb-4 space-y-2">
              <li>Course purchases older than 30 days.</li>
              <li>Digital downloads or tools purchased separately.</li>
              <li>Live webinar attendance fees (non-refundable after the event).</li>
            </ul>
