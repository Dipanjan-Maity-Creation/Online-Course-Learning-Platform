      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 exo-regular">Cookie Policy</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Understand how TradingGuru uses cookies to enhance your experience.
            </p>
          </div>
          <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 exo-regular">What Are Cookies?</h3>
            <p className="text-gray-600 mb-4">
              Cookies are small text files stored on your device to help us improve our website
              functionality and user experience.
            </p>

            <h3 className="text-xl font-semibold mb-4 exo-regular">How We Use Cookies</h3>
            <p className="text-gray-600 mb-4">
              We use cookies for analytics, personalization, and to remember your preferences during
              your visit.
            </p>

            <h3 className="text-xl font-semibold mb-4 exo-regular">Managing Cookies</h3>
            <p className="text-gray-600 mb-4">
              You can manage or disable cookies through your browser settings. Note that disabling
              cookies may affect website functionality.
            </p>

            <h3 className="text-xl font-semibold mb-4 exo-regular">Third-Party Cookies</h3>
            <p className="text-gray-600 mb-4">
              We may use third-party services (e.g., Google Analytics) that set their own cookies.
              Review their policies for more details.
            </p>
          </div>
        </div>
      </section>
