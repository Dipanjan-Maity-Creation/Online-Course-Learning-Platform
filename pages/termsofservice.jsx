      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 exo-regular">Terms of Service</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Please read these terms carefully before using TradingGuru's services.
            </p>
          </div>
          <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 exo-regular">Acceptance of Terms</h3>
            <p className="text-gray-600 mb-4">
              By accessing or using our website, you agree to be bound by these Terms of Service.
            </p>

            <h3 className="text-xl font-semibold mb-4 exo-regular">User Conduct</h3>
            <p className="text-gray-600 mb-4">
              You agree not to use our services for any unlawful purpose or to infringe on others'
              rights.
            </p>

            <h3 className="text-xl font-semibold mb-4 exo-regular">Payment and Subscriptions</h3>
            <p className="text-gray-600 mb-4">
              All fees are non-refundable except as outlined in our Refund Policy. Subscriptions
              renew automatically unless canceled.
            </p>

            <h3 className="text-xl font-semibold mb-4 exo-regular">Termination</h3>
            <p className="text-gray-600 mb-4">
              We reserve the right to terminate or suspend your access if you violate these terms.
            </p>

            <h3 className="text-xl font-semibold mb-4 exo-regular">Governing Law</h3>
            <p className="text-gray-600 mb-4">
              These terms are governed by the laws of New York, USA. Disputes will be resolved in
              New York courts.
            </p>
          </div>
        </div>
